@php
    $meta_title = "Sejarah TPA Al-Ikhlas | Masjid Al-Ikhlas Dalang";
    $meta_description = "Pelajari sejarah TPA Al-Ikhlas Dalang, perjalanan dalam mendidik generasi Qur'ani berakhlak mulia. Temukan visi, misi, dan semangat kami.";
    $meta_keywords = "TPA Al-Ikhlas, sejarah TPA, TPA Dalang, masjid al ikhlas dalang, pendidikan islam, visi misi tpa, masjid dalang";
@endphp
                    ...
                    <div class="mb-8">
                        <div class="flex items-center gap-3 mb-2">
                            ...
                            <h2 class="text-3xl md:text-4xl font-bold text-gray-800">
                                {{ $history?->title ?? 'Awal Mula Berdirinya TPA Al-Ikhlas' }}
                            </h2>
                        </div>
