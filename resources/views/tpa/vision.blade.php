@php
    $meta_title = "Visi dan Misi TPA Al-Ikhlas | Dalang";
    $meta_description = "Pelajari visi dan misi TPA Al-Ikhlas Dalang dalam mendidik generasi Qur'ani yang berakhlak mulia.";
    $meta_keywords = "TPA Al-Ikhlas, visi misi TPA, pendidikan Islam, TPA Dalang, generasi Qur'ani";
@endphp
    ...
    <div class="islamic-pattern min-h-[100vh] flex justify-center">
        ...
        <section class="py-16 md:py-24 px-4 w-full max-w-6xl">
            <div class="text-center mb-12">
                <h2 class="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Visi & Misi TPA Al-Ikhlas</h2>
            ...
            @else
                <div class="text-center text-gray-500 italic">
                    Belum ada data visi & misi yang ditambahkan untuk TPA.
                </div>
            @endif
        </section>
    </div>
