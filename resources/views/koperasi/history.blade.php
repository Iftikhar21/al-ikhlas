@php
    $meta_title = "Sejarah Koperasi Al-Ikhlas | Masjid Al-Ikhlas Dalang";
    $meta_description = "Pelajari sejarah Koperasi Al-Ikhlas, perjalanan dalam membangun ekonomi umat melalui koperasi. Temukan visi, misi, dan semangat kami.";
    $meta_keywords = "koperasi masjid, sejarah koperasi, koperasi al ikhlas, masjid al ikhlas dalang, ekonomi umat, visi misi koperasi";
@endphp
        ...
        <section class="relative h-screen min-h-[600px] flex items-center justify-center overflow-hidden">
            ...
            <div class="absolute inset-0 bg-center bg-cover opacity-30 flex items-center justify-center z-0">
                @if($history && $history->image)
                    <img src="{{ asset('storage/' . $history->image) }}" alt="Background Sejarah Koperasi"
            ...
            <div class="relative z-10 text-center px-4 max-w-4xl mx-auto">
                <div class="mb-6">
                    <div class="inline-block p-4 bg-white bg-opacity-20 rounded-full backdrop-blur-sm mb-4 w-64 h-64">
                        <img src="{{ asset('img/al_ikhlas_logo.jpg') }}" class="rounded-full" alt="Logo Koperasi">
                    </div>
                </div>

                <h1 class="text-4xl md:text-6xl font-bold text-white mb-6 drop-shadow-lg">
                    {{ $history?->title ?? 'Sejarah Koperasi Al-Ikhlas' }}
                </h1>
                <p class="text-lg md:text-xl text-white text-opacity-95 max-w-2xl mx-auto leading-relaxed drop-shadow">
                    {{ $history?->subtitle ?? 'Perjalanan kami dalam membangun koperasi untuk kesejahteraan umat.' }}
                </p>
            </div>
            ...
            <div class="max-w-5xl mx-auto">
                <div
                    ...
                    <div class="mb-8">
                        <div class="flex items-center gap-3 mb-2">
                            ...
                            <h2 class="text-3xl md:text-4xl font-bold text-gray-800">
                                {{ $history?->title ?? 'Awal Berdirinya Koperasi' }}
                            </h2>
                        </div>
                    ...
                    <div class="prose prose-lg max-w-none text-gray-700 leading-relaxed whitespace-pre-line">
                        {!! nl2br(e($history?->content ?? 'Belum ada sejarah koperasi yang ditambahkan.')) !!}
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="py-16 md:py-24 px-4">
            <div class="max-w-6xl mx-auto">
                <div class="text-center mb-12">
                    <h2 class="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Visi & Misi Koperasi</h2>
                    <p class="text-lg text-gray-600">Panduan kami dalam membangun koperasi untuk kesejahteraan anggota dan
                        masyarakat</p>
                </div>
                ...
                @else
                    <div class="text-center text-gray-500 italic">
                        Belum ada data visi & misi koperasi yang ditambahkan.
                    </div>
                @endif
            </div>
        </section>
