@php
    $meta_title = "Visi dan Misi Koperasi Al-Ikhlas | Masjid Al-Ikhlas Dalang";
    $meta_description = "Pelajari visi dan misi Koperasi Al-Ikhlas dalam membangun ekonomi umat dan meningkatkan kesejahteraan melalui koperasi.";
    $meta_keywords = "Koperasi Al-Ikhlas, visi misi koperasi, koperasi masjid, ekonomi umat, kesejahteraan masyarakat";
@endphp
...
@section('content')
    ...
    <div class="islamic-pattern min-h-[100vh] flex justify-center">
        <!-- Vision & Mission Section -->
        <section class="py-16 md:py-24 px-4 w-full max-w-6xl">
            <div class="text-center mb-12">
                <h2 class="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Visi & Misi Koperasi Al-Ikhlas</h2>
                <p class="text-lg text-gray-600">Panduan kami dalam membangun ekonomi umat dan kesejahteraan anggota
                    koperasi</p>
            </div>
            ...
            @else
                <div class="text-center text-gray-500 italic">
                    Belum ada data visi & misi yang ditambahkan untuk Koperasi.
                </div>
            @endif
        </section>
    </div>
