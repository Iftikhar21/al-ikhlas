...
@section('title', 'Tambah Struktur Organisasi Masjid')
@section('content')
        ...
        <div class="max-w-full mx-auto">
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 mb-4">
                <div class="flex items-center justify-between">
                    <div>
                        <h2 class="text-3xl font-bold text-gray-800 mb-2">Tambah Struktur Organisasi Masjid Baru</h2>
                        <p class="text-gray-600">Upload gambar struktur organisasi lembaga Anda</p>
                    </div>
                    <a href="{{ route('admin.masjid.structure.index') }}"
            ...
            <form id="createForm" action="{{ route('admin.masjid.structure.store') }}" method="POST" enctype="multipart/form-data"
