...
@section('title', 'Kelola Struktur Organisasi Masjid')
@section('content')
        ...
        <div class="max-w-full mx-auto">
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 mb-4">
                <div class="flex items-center justify-between">
                    <div>
                        <h2 class="text-3xl font-bold text-gray-800 mb-2">Struktur Organisasi Masjid</h2>
                        <p class="text-gray-600">Kelola struktur organisasi masjid Anda</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 mb-8">
                <div class="flex flex-col md:flex-row md:items-center justify-between mb-6">
                    <h1 class="text-2xl font-bold text-gray-800 mb-4 md:mb-0">Struktur Organisasi Masjid</h1>

                    @if(!$structure)
                        <a href="{{ route('admin.masjid.structure.create') }}"
                    ...
                    @else
                        <a href="{{ route('admin.masjid.structure.edit', $structure->id) }}"
                            ...
                            <div class="flex flex-col lg:flex-row gap-6">
                                ...
                                <div class="lg:w-1/3">
                                    ...
                                    <div class="space-y-3">
                                        ...
                                        <!-- Delete -->
                                        <form action="{{ route('admin.masjid.structure.destroy', $structure->id) }}" method="POST"
                ...
                @else
                    ...
                    <div class="text-center py-16">
                        <div class="max-w-md mx-auto">
                            ...
                            <p class="text-gray-400 mb-6">Mulai dengan menambahkan struktur organisasi masjid Anda</p>
                            <a href="{{ route('admin.masjid.structure.create') }}"
