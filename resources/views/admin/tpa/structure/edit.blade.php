...
@section('title', 'Edit Struktur Organisasi TPA')
@section('content')
        ...
        <div class="max-w-full mx-auto">
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 mb-4">
                <div class="flex items-center justify-between">
                    <div>
                        <h2 class="text-3xl font-bold text-gray-800 mb-2">Edit Struktur Organisasi TPA</h2>
                        <p class="text-gray-600">Perbarui informasi struktur organisasi tpa yang sudah ada</p>
                    </div>
            ...
            <form id="updateForm" action="{{ route('admin.tpa.structure.update', $structure->id) }}" method="POST"
