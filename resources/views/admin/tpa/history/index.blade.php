        ...
        <div class="max-w-full mx-auto">
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 mb-4">
                <div class="flex items-center justify-between">
                    <div>
                        <h2 class="text-3xl font-bold text-gray-800 mb-2">Sejarah TPA</h2>
                        <p class="text-gray-600">Kelola konten sejarah tpa Anda</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 mb-8">
                <div class="flex flex-col md:flex-row md:items-center justify-between mb-6">
                    <h1 class="text-2xl font-bold text-gray-800 mb-4 md:mb-0">Sejarah TPA</h1>

                    @if(!$history)
                        <a href="{{ route('admin.tpa.history.create') }}"
                    ...
                    @else
                        <a href="{{ route('admin.tpa.history.edit', $history->id) }}"
                            ...
                            <div class="flex flex-col lg:flex-row gap-6">
                                ...
                                <div class="lg:w-2/3">
                                    ...
                                    <div class="mt-6 pt-6 border-t border-gray-100 flex flex-wrap gap-3">
                                        ...
                                        <!-- Delete -->
                                        <form action="{{ route('admin.tpa.history.destroy', $history->id) }}" method="POST"
                ...
                @else
                    ...
                    <div class="text-center py-16">
                        <div class="max-w-md mx-auto">
                            ...
                            <p class="text-gray-400 mb-6">Mulai dengan menambahkan sejarah lembaga Anda</p>
                            <a href="{{ route('admin.tpa.history.create') }}"
