        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                <div class="flex items-center justify-between">
                    <div>
                        <h2 class="text-3xl font-bold text-gray-800 mb-2">Tambah Pengajar</h2>
                        <p class="text-gray-600">Tambah data pengajar baru</p>
                    </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200">
                <form action="{{ route('admin.tpa.teachers.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div>
                            ...
                            <div class="flex items-start gap-4">
                                <div class="w-28 h-28 bg-gray-50 rounded-lg border border-gray-200 flex items-center justify-center overflow-hidden">
                                    <img id="fotoPreview" src="{{ asset('img/placeholder-user.png') }}" alt="Preview" class="w-full h-full object-cover">
                                </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        input.addEventListener('change', function (e) {
            ...
            if (!file) {
                preview.src = "{{ asset('img/placeholder-user.png') }}";
                return;
            }
