                ...
                : 'bg-gray-100 text-gray-700 border border-gray-200' }}">
                                    ...
                                    <div class="p-4">
                                        ...
                                        <div class="flex items-center justify-center space-x-2 pt-2 border-t border-gray-100">
                                            <!-- View -->
                                            <a href="{{ route('admin.tpa.programs.show', $program->id) }}"
                                            ...
                                            <!-- Edit -->
                                            <a href="{{ route('admin.tpa.programs.edit', $program->id) }}"
                                            ...
                                            <!-- Delete -->
                                            <form action="{{ route('admin.tpa.programs.destroy', $program->id) }}" method="POST" id="deleteForm-{{ $program->id }}">
                                                        @csrf
                                                        @method('DELETE')
                                            </form>
