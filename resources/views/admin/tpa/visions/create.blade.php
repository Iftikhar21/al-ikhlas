...
@section('title', isset($vision) ? 'Edit Visi & Misi TPA' : 'Tambah Visi & Misi TPA Baru')
@section('content')
    <main class="pt-23 p-4 lg:ml-80 transition-all bg-gray-100">
        <div class="max-w-full mx-auto">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        <h2 class="text-3xl font-bold text-gray-800 mb-2">
                            {{ isset($vision) ? 'Edit Visi & Misi TPA' : 'Tambah Visi & Misi TPA Baru' }}
                        </h2>
                        <p class="text-gray-600">
                            {{ isset($vision) ? 'Perbarui informasi visi dan misi tpa yang sudah ada' : 'Buat visi dan misi tpa dengan informasi yang jelas dan terstruktur' }}
                        </p>
                    </div>
            ...
            <form id="visionForm" method="POST"
                action="{{ isset($vision) ? route('admin.tpa.visions.update', $vision->id) : route('admin.tpa.visions.store') }}"
                class="space-y-6">
                @csrf
                @if(isset($vision))
                    @method('PUT')
