...
@section('title', 'Edit Visi & Misi TPA')
@section('content')
        ...
        <div class="max-w-full mx-auto">
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 mb-4">
                <div class="flex items-center justify-between">
                    <div>
                        <h2 class="text-3xl font-bold text-gray-800 mb-2">Edit Visi & Misi TPA</h2>
                        <p class="text-gray-600">Perbarui informasi visi dan misi tpa yang sudah ada</p>
                    </div>
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <textarea id="vision" name="vision" rows="4"
                                ...
                                placeholder="Tuliskan visi tpa yang jelas dan inspiratif..."
                                required>{{ old('vision', $vision->vision) }}</textarea>
                            @error('vision')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                            <p class="mt-1 text-xs text-gray-500">Visi harus mencerminkan tujuan jangka panjang tpa</p>
                        </div>
                                    ...
                                    <div class="mission-group flex items-start gap-3">
                                        ...
                                        <div class="flex-1">
                                            <input type="text" name="missions[]" value="{{ $mission }}"
                                                ...
                                                placeholder="Tuliskan poin misi tpa...">
    ...
    <script>
        ...
        document.getElementById('updateForm').addEventListener('submit', function (e) {
            ...
            if (!vision) {
                isValid = false;
                errorMessages.push('Visi tpa harus diisi');
            }
