...
@section('content')
        ...
        <div class="max-w-full mx-auto">
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 mb-4">
                <div class="flex items-center justify-between">
                    <div>
                        <h2 class="text-3xl font-bold text-gray-800 mb-2">Edit Kegiatan</h2>
                        <p class="text-gray-600">Perbarui informasi kegiatan yang sudah ada</p>
                    </div>
            ...
            <form id="updateForm" action="{{ route('admin.koperasi.activity.update', $activity->id) }}" method="POST" enctype="multipart/form-data"
                                class="space-y-6">
                                @csrf @method('PUT')
                                    ...
                                    <div class="p-6 space-y-6">
                                        ...
                                        <div>
                                            <label class="block text-sm font-medium text-gray-700 mb-2 flex items-center">
                                                ...
                                                Thumbnail Kegiatan (Rasio 16:9) (MAX 10MB)
                                            </label>
                                                    ...
                                                    <div class="relative w-full max-w-2xl mx-auto">
                                                        <div class="aspect-w-16 aspect-h-9 bg-gray-100 rounded-lg overflow-hidden border">
                                                            <img id="thumbnailPreview" class="w-full h-48 object-cover"
                                                                src="{{ asset('storage/' . $activity->thumbnail) }}" alt="Thumbnail">
                                                        </div>
                                            ...
                                            <div id="thumbnailUploadArea"
                                                class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-blue-400 transition cursor-pointer bg-gray-50 {{ $activity->thumbnail ? 'hidden' : '' }}">
    ...
    $paragraphs = explode("\n\n", $activity->content);
                                        ...
                                        <div>
                                            ...
                                            <div id="supportPhotosContainer" class="space-y-4">
                                                @foreach($activity->koperasi_activity_photos as $i => $photo)
                                            ...
                                            <button type="button" onclick="addSupportPhoto()"
                                                ...
                                                <div class="text-center">
                                                    ...
                                                    <!-- teks kecil di bawah -->
                                                    <p class="text-xs text-gray-500">Upload foto tambahan untuk melengkapi kegiatan</p>
                                                </div>
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="bg-gray-50 px-6 py-4 border-t border-gray-200 flex justify-end">
                                        <button type="button" onclick="openConfirmModal('globalConfirmModal', () => document.getElementById('updateForm').submit(), {
                                                ...
                                                message: 'Apakah Anda yakin ingin mengupdate kegiatan ini?',
    ...
    <script>
                        ...
                        function removeSupportPhotoPreview(button) {
                            ...
                            const input = previewContainer.previousElementSquel.querySelector('.support-photo-input');
                            input.value = '';
