...
@section('content')
        ...
        <div class="max-w-full mx-auto">
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 mb-4">
                <div class="flex items-center justify-between">
                    <div>
                        <h2 class="text-3xl font-bold text-gray-800 mb-2">Tambah Kegiatan Baru</h2>
                        <p class="text-gray-600">Dokumentasikan kegiatan koperasi dengan informasi yang lengkap</p>
                    </div>
            ...
            <!-- Form -->
            <form action="{{ route('admin.koperasi.activity.store') }}" method="POST" enctype="multipart/form-data"
                class="space-y-6" id="activityForm">
                @csrf
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                    ...
                    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 px-6 py-4 border-b border-gray-200">
                        <h2 class="text-lg font-semibold text-gray-800 flex items-center">
                            <i data-lucide="clipboard-list" class="w-4 h-4 mr-2 text-blue-500 text-xs"></i>
                            Informasi Kegiatan
                        </h2>
                    </div>
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2 flex items-center">
                                ...
                                Foto Utama (Rasio 16:9) (MAX 10MB)
                                <span class="text-red-500 ml-1">*</span>
                            </label>
                            ...
                            <div id="thumbnailPreviewContainer" class="{{ old('thumbnail_data') ? '' : 'hidden' }} mb-4">
                                ...
                                <p class="text-center text-sm text-gray-500 mt-2">Preview foto utama - Pastikan gambar
                                    sesuai
                            ...
                            <div id="thumbnailUploadArea"
                                ...
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <p class="text-sm text-gray-600 mb-1">Klik untuk upload foto utama</p>
                            ...
                            <div id="cropModal"
                                ...
                                <div class="bg-white rounded-xl max-w-4xl w-full max-h-[90vh] overflow-hidden">
                                    <div class="flex justify-between items-center p-4 border-b border-gray-200">
                                        <h3 class="text-lg font-semibold text-gray-800">Crop Foto Utama (16:9)</h3>
                        ...
                        <div>
                            <div class="flex justify-between items-center mb-2">
                                <label class="block text-sm font-medium text-gray-700 flex items-center">
                                    <i data-lucide="file-text" class="w-4 h-4 mr-2 text-blue-500 text-xs"></i>
                                    Deskripsi Kegiatan
                                    <span class="text-red-500 ml-1">*</span>
                                </label>
                            ...
                            <div id="paragraphsContainer" class="space-y-4">
                                ...
                                @else
                                    <div class="paragraph-group border border-gray-200 rounded-lg p-4 bg-white">
                                        ...
                                        <textarea name="paragraphs[]" rows="4"
                                            class="w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 px-3 py-2 transition resize-none"
                                            placeholder="Tulis deskripsi kegiatan di sini..." required></textarea>
                                    </div>
                                @endif
                            </div>
                        </div>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2 flex items-center">
                                <i data-lucide="images" class="w-4 h-4 mr-2 text-blue-500 text-xs"></i>
                                ...
                                @if(old('support_photos') && count(old('support_photos')) > 0)
                                    @foreach(old('support_photos') as $index => $photo)
                                        <div class="support-photo-item border border-gray-200 rounded-lg p-4 bg-white">
                                            <div class="flex justify-between items-center mb-3">
                                                <span class="text-sm font-medium text-gray-700">Foto Dokumentasi
                                                    {{ $index + 1 }}</span>
                            ...
                            <button type="button" onclick="addSupportPhoto()"
                                ...
                                <div class="text-center">
                                    ...
                                    <div class="flex items-center justify-center mb-1">
                                        ...
                                        <span class="text-blue-600 font-medium">Tambah Foto Dokumentasi</span>
                                    </div>

                                    <!-- teks kecil di bawah -->
                                    <p class="text-xs text-gray-500">Upload foto tambahan untuk melengkapi dokumentasi
                                        kegiatan</p>
                                </div>
                            </button>
                        </div>
                    ...
                    <div class="bg-gray-50 px-6 py-4 border-t border-gray-200 flex justify-end gap-3">
                        <a href="{{ route('admin.koperasi.activity.index') }}"
                            class="px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-800 rounded-lg font-medium transition">
                            Batal
                        </a>
                        <button type="submit"
    ...
    <script>
        ...
        function addSupportPhoto() {
            ...
            newPhoto.innerHTML = `
                    <div class="flex justify-between items-center mb-3">
                        <span class="text-sm font-medium text-gray-700">Foto Dokumentasi ${supportPhotoCount}</span>
                        <button type="button" onclick="removeSupportPhoto(this)"
                            class="text-white px-2 py-1 rounded bg-red-500 hover:bg-red-700 text-sm flex items-center">
                            <i data-lucide="trash" class="w-4 h-4 text-white text-xs"></i>
                            Hapus
        ...
        function updateSupportPhotoNumbers() {
            ...
            photos.forEach((photo, index) => {
                ...
                span.textContent = `Foto Dokumentasi ${index + 1}`;
            });
        ...
        document.getElementById('activityForm').addEventListener('submit', function (e) {
            ...
            if (!title) {
                isValid = false;
                errorMessages.push('Judul kegiatan harus diisi');
            }
            ...
            if (!thumbnailData) {
                isValid = false;
                errorMessages.push('Foto utama harus diisi');
            }
