...
@section('title', 'Kelola Visi & Misi Koperasi')
@section('content')
        ...
        <div class="max-w-full mx-auto">
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 mb-4">
                <div class="flex items-center justify-between">
                    <div>
                        <h2 class="text-3xl font-bold text-gray-800 mb-2">Visi & Misi Koperasi</h2>
                        <p class="text-gray-600">Kelola visi dan misi koperasi Anda</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 mb-8">
                <div class="flex flex-col md:flex-row md:items-center justify-between mb-6">
                    ...
                    @if($visions->isEmpty())
                        <a href="{{ route('admin.koperasi.visions.create') }}"
                            ...
                            <div class="bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm">
                                ...
                                <div class="bg-gradient-to-r from-purple-50 to-indigo-50 px-6 py-4 border-b border-purple-100">
                                    <div class="flex flex-col md:flex-row md:items-center justify-between">
                                        <div>
                                            ...
                                            <p class="text-purple-600 font-medium mt-1">Dokumen Visi & Misi Koperasi</p>
                                        </div>
                                ...
                                <div class="p-6">
                                    ...
                                    <div class="mt-6 pt-6 border-t border-gray-100 flex flex-wrap gap-3">
                                        <!-- Edit -->
                                        <a href="{{ route('admin.koperasi.visions.edit', $item->id) }}"
                                        ...
                                        <!-- Delete -->
                                        <form action="{{ route('admin.koperasi.visions.destroy', $item->id) }}" method="POST"
                ...
                @else
                    ...
                    <div class="text-center py-16">
                        <div class="max-w-md mx-auto">
                            ...
                            <p class="text-gray-400 mb-6">Mulai dengan menambahkan visi dan misi koperasi Anda</p>
                            <a href="{{ route('admin.koperasi.visions.create') }}"
