...
@section('title', isset($vision) ? 'Edit Visi & Misi Koperasi' : 'Tambah Visi & Misi Koperasi Baru')
@section('content')
    <main class="pt-23 p-4 lg:ml-80 transition-all bg-gray-100">
        <div class="max-w-full mx-auto">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        <h2 class="text-3xl font-bold text-gray-800 mb-2">
                            {{ isset($vision) ? 'Edit Visi & Misi Koperasi' : 'Tambah Visi & Misi Koperasi Baru' }}
                        </h2>
                        <p class="text-gray-600">
                            {{ isset($vision) ? 'Perbarui informasi visi dan misi koperasi yang sudah ada' : 'Buat visi dan misi koperasi dengan informasi yang jelas dan terstruktur' }}
                        </p>
                    </div>
                    <a href="{{ route('admin.koperasi.visions.index') }}"
            ...
            <form id="visionForm" method="POST"
                action="{{ isset($vision) ? route('admin.koperasi.visions.update', $vision->id) : route('admin.koperasi.visions.store') }}"
                class="space-y-6">
                @csrf
                @if(isset($vision))
                    @method('PUT')
