...
@section('title', 'Edit Visi & Misi Koperasi')
@section('content')
<main class="pt-23 p-4 lg:ml-80 transition-all bg-gray-100">
        <div class="max-w-full mx-auto">
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 mb-4">
                <div class="flex items-center justify-between">
                    <div>
                        <h2 class="text-3xl font-bold text-gray-800 mb-2">Edit Visi & Misi Koperasi</h2>
                        <p class="text-gray-600">Perbarui informasi visi dan misi koperasi yang sudah ada</p>
                    </div>
                    <a href="{{ route('admin.tpa.visions.index') }}"
            ...
            <form id="updateForm" action="{{ route('admin.tpa.visions.update', $vision->id) }}" method="POST"
                class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                    ...
                    <div class="bg-gradient-to-r from-purple-50 to-indigo-50 px-6 py-4 border-b border-gray-200">
                        <h2 class="text-lg font-semibold text-gray-800 flex items-center">
                            ...
                            Edit Informasi Visi & Misi Koperasi
                        </h2>
                    </div>
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <textarea id="vision" name="vision" rows="4"
                                ...
                                placeholder="Tuliskan visi koperasi yang jelas dan inspiratif..."
                                required>{{ old('vision', $vision->vision) }}</textarea>
                            @error('vision')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                            <p class="mt-1 text-xs text-gray-500">Visi harus mencerminkan tujuan jangka panjang koperasi</p>
                        </div>
                                    ...
                                    <div class="mission-group flex items-start gap-3">
                                        ...
                                        <div class="flex-1">
                                            <input type="text" name="missions[]" 
                                                ...
                                                placeholder="Tuliskan poin misi koperasi...">
    ...
    <script>
        ...
        document.getElementById('updateForm').addEventListener('submit', function (e) {
            ...
            if (!vision) {
                isValid = false;
                errorMessages.push('Visi koperasi harus diisi');
            }
