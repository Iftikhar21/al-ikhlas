                    ...
                    <div class="container mx-auto">
                                            ...
                                            <tr class="hover:bg-gray-50 transition-colors">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <div class="flex items-center gap-2">
                                                        ...
                                                        <!-- Delete Form -->
                                                        <form action="{{ route('admin.ummi-levels.destroy', $level->id) }}" method="POST"
                                                            id="deleteForm-{{ $level->id }}">
                                                            @csrf
                                                            @method('DELETE')
                                                        </form>

                                                        <!-- Delete Button -->
                                                        <button type="button" onclick="openConfirmModal('globalConfirmModal', () => document.getElementById('deleteForm-{{ $level->id }}').submit(), {
                        ...
                        <div id="addUmmiModal" class="hidden fixed inset-0 backdrop-blur-xs bg-opacity-50 flex items-center justify-center p-4 z-50">
                            <div class="bg-white rounded-lg shadow-lg w-full max-w-md">
                                ...
                                <!-- Form -->
                                <form action="{{ route('admin.ummi-levels.store') }}" method="POST">
                                    @csrf
                                                        ...
                                                        @if ($index === 0)
                                                            <td rowspan="{{ $rowCount }}"
                                                                ...
                                                                <div class="flex flex-col items-center justify-center gap-2">
                                                                    ...
                                                                    <button type="button" onclick="openConfirmModal('globalConfirmModal', () => document.getElementById('deleteForm-{{ $schedule->id }}').submit(), {
                                                                                                                title: 'Hapus Jadwal',
                                        ...
                                        <div class="p-4">
                                            ...
                                            <div class="flex justify-between items-center">
                                                ...
                                                <div class="flex space-x-2">
                                                    ...
                                                    <button type="button"
                                                        onclick="openConfirmModal('globalConfirmModal', () => document.getElementById('deleteForm-{{ $event->id }}').submit(), {
                                                                                                                                                            title: 'Hapus Event',
