...
@section('title', isset($vision) ? 'Edit Visi & Misi' : 'Tambah Visi & Misi')
@section('content')
    <main class="pt-23 p-4 lg:ml-80 transition-all bg-gray-100">
        <div class="max-w-full mx-auto">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        <h2 class="text-3xl font-bold text-gray-800 mb-2">
                            {{ isset($vision) ? 'Edit Visi & Misi' : 'Tambah Visi & Misi Baru' }}
                        </h2>
                        <p class="text-gray-600">
                            {{ isset($vision) ? 'Perbarui informasi visi dan misi yang sudah ada' : 'Buat visi dan misi lembaga dengan informasi yang jelas dan terstruktur' }}
                        </p>
                    </div>
            ...
            <form id="visionForm" method="POST"
                action="{{ isset($vision) ? route('admin.visions.update', $vision->id) : route('admin.visions.store') }}"
                class="space-y-6">
                @csrf
                @if(isset($vision))
                    @method('PUT')
