...
@section('title', 'Edit Visi & Misi')@section('content')<main class="pt-23 p-4 lg:ml-80 transition-all bg-gray-100">
        <div class="max-w-full mx-auto">
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 mb-4">
                <div class="flex items-center justify-between">
                    <div>
                        <h2 class="text-3xl font-bold text-gray-800 mb-2">Edit Visi & Misi</h2>
                        <p class="text-gray-600">Perbarui informasi visi dan misi yang sudah ada</p>
                    </div>
                    <a href="{{ route('admin.visions.index') }}"
            ...
            <form id="updateForm" action="{{ route('admin.visions.update', $vision->id) }}" method="POST"
                class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                    ...
                    <div class="bg-gradient-to-r from-purple-50 to-indigo-50 px-6 py-4 border-b border-gray-200">
                        <h2 class="text-lg font-semibold text-gray-800 flex items-center">
                            <i data-lucide="pencil" class="w-4 h-4 mr-2 text-purple-500 text-xs"></i>
                            Edit Informasi Visi & Misi
                        </h2>
                    </div>
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <textarea id="vision" name="vision" rows="4"
                                ...
                                placeholder="Tuliskan visi lembaga yang jelas dan inspiratif..."
                                required>{{ old('vision', $vision->vision) }}</textarea>
                            @error('vision')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                            <p class="mt-1 text-xs text-gray-500">Visi harus mencerminkan tujuan jangka panjang lembaga</p>
                        </div>
                        ...
                        <div>
                                    ...
                                    <div class="mission-group flex items-start gap-3">
                                        ...
                                        <div class="flex-1">
                                            <input type="text" name="missions[]" 
                                                ...
                                                placeholder="Tuliskan poin misi lembaga...">
                            ...
                            <p class="mt-2 text-xs text-gray-500">Misi harus spesifik, terukur, dan dapat diimplementasikan</p>
                        </div>
                    </div>
                    ...
                    <div class="bg-gray-50 px-6 py-4 border-t border-gray-200 flex justify-end gap-3">
                        ...
                        <button type="button" onclick="openConfirmModal('globalConfirmModal', () => document.getElementById('updateForm').submit(), {
                                    ...
                                    message: 'Apakah Anda yakin ingin mengupdate visi & misi ini?',
    ...
    <script>
        ...
        document.getElementById('updateForm').addEventListener('submit', function (e) {
            ...
            if (!vision) {
                isValid = false;
                errorMessages.push('Visi lembaga harus diisi');
            }
