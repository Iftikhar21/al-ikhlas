        ...
        <div class="max-w-full mx-auto">
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 mb-4">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-gray-600">Kelola struktur organisasi lembaga Anda</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 mb-8">
                <div class="flex flex-col md:flex-row md:items-center justify-between mb-6">
                    <h1 class="text-2xl font-bold text-gray-800 mb-4 md:mb-0">Struktur Organisasi Lembaga</h1>
                    ...
                    @else
                        <a href="{{ route('admin.structure.edit', $structure->id) }}"
                ...
                @else
                    ...
                    <div class="text-center py-16">
                        <div class="max-w-md mx-auto">
                            ...
                            <p class="text-gray-400 mb-6">Mulai dengan menambahkan struktur organisasi lembaga Anda</p>
                            <a href="{{ route('admin.structure.create') }}"
