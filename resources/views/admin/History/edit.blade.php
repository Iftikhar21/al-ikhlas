        ...
        <div class="max-w-full mx-auto">
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 mb-4">
                <div class="flex items-center justify-between">
                    <div>
                        <h2 class="text-3xl font-bold text-gray-800 mb-2">Edit Sejarah</h2>
                        <p class="text-gray-600">Perbarui informasi sejarah yang sudah ada</p>
                    </div>
            ...
            <form id="updateForm" action="{{ route('admin.history.update', $history->id) }}" method="POST"
