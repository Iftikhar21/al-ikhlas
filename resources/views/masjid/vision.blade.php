@php
    $meta_title = "Visi dan Misi Masjid Al-Ikhlas | Dalang";
    $meta_description = "Pelajari visi dan misi Masjid Al-Ikhlas Dalang dalam membentuk generasi Qur'ani yang berakhlak mulia.";
    $meta_keywords = "masjid al ikhlas, visi misi masjid, pendidikan islam, dakwah masjid, masjid dalang";
@endphp
    ...
    <div class="islamic-pattern min-h-[100vh] flex justify-center">
        ...
        <section class="py-16 md:py-24 px-4 w-full max-w-6xl">
            <div class="text-center mb-12">
                <h2 class="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Visi & Misi Masjid Al-Ikhlas</h2>
